...
class WebAgentDemoTest(unittest.TestCase):
    def test_home_page_contains_agent_system_shell(self):
        ...
        self.assertIn("const pickupRoute = dispatchRelationshipRoute(courierPoint, pickupPoint);", html)
        ...
        self.assertIn(".route-svg { z-index: 5; pointer-events: none; }", html)
        ...
        self.assertIn("background: linear-gradient(180deg, rgba(255,255,255,.98), rgba(248,250,252,.96));", html)
        ...
        self.assertIn("单城月节约估算", html)
        self.assertIn("批次节约", html)
        self.assertIn("rawPerOrderSaving * 0.03", html)
        self.assertIn("每单约节约", html)
