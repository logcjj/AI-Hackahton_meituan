...
class WebAgentDemoTest(unittest.TestCase):
    def test_home_page_contains_agent_system_shell(self):
        ...
        self.assertIn("roadFollowingRoute(courierPoints[0], pickupPoint, mapLayers)", html)
        self.assertIn('"route-source": "delivery-routes-road-graph-v3"', html)
        ...
        self.assertIn("entity.x = Number(projected[0].toFixed(2));", html)
        ...
        self.assertIn("const visiblePickupRoute = Array.isArray(pickupRoute.roadCore)", html)
        self.assertIn('"road-core-points": visiblePickupRoute.length', html)
        ...
        self.assertIn("dispatchEndpointConnectorsFor(pickupRoute, assignment.id, pickupMeta, routeStyle)", html)
