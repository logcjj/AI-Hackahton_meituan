...
class WebAgentDemoTest(unittest.TestCase):
    def test_home_page_contains_dispatch_workbench_shell(self):
        ...
        required_markers = [
            ...
            "实时累计对比栏",
            "决策轮次时间线",
            'data-decision-route="planner"',
            'id="decision-timeline"',
            'id="decision-reasoning-canvas"',
            'id="decision-context-pane"',
            "ReasonGraph Planner",
            'data-reasoning-surface="advantage-first"',
            'data-reasoning-pattern="reasongraph-six-node"',
            'id="decision-candidate-paths"',
            'data-reasoning-pattern="candidate-elimination"',
            "候选路径",
            "淘汰",
            ...
            "function renderReasonGraph",
            "function renderCandidatePaths",
