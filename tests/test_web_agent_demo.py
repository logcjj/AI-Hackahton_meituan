...
class WebAgentDemoTest(unittest.TestCase):
    def test_home_page_contains_agent_system_shell(self):
        ...
        self.assertIn("const targetZoom = Math.min(17, map.getZoom() + 0.55)", html)
        self.assertIn("const targetZoom = Math.max(11, map.getZoom() - 0.55)", html)
        ...
        self.assertIn('frame.setAttribute("draggable", "true")', html)
        ...
        self.assertIn("dispatchEndpointConnectorsFor(pickupRoute, assignment.id, pickupMeta)", html)
