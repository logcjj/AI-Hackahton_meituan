...
class WebAgentDemoTest(unittest.TestCase):
    def test_home_page_contains_dispatch_workbench_shell(self):
        ...
        required_markers = [
            ...
            'data-visual-polish="chinese-enterprise-workbench-v3"',
            ...
            "最近命中时间",
            "全天订单全集",
            'data-orders-route="preloaded-demand-pool"',
            "订单池看板",
            'id="orders-command"',
            'data-orders-surface="preloaded-order-pool"',
            ...
            "我方结果",
            "全天骑手班次",
            'data-riders-route="capacity-board"',
            "骑手运力看板",
            'id="riders-command"',
            'data-riders-surface="capacity-board"',
