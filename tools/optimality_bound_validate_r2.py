#!/usr/bin/env python3
"""
optimality_bound_validate_r2.py
===============================

R1 validation harness for autosolver/optimality_bound_r2.py
...
Pure stdlib. Run:  python3 tools/optimality_bound_validate_r2.py [--per-regime N]
"""
...
from autosolver import optimality_bound_r2 as ob  # noqa: E402  (R2 module)
...
def evaluate_case(name, regime, text, solver):
    ...
    return {
        ...
        "concave": cert.concave_lb, "assign": cert.assignment_lb, "lagr": cert.lagrangian_lb,
