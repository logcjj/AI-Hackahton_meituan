#!/usr/bin/env python3
"""
optimality_bound_validate.py
============================

Validation harness for autosolver/optimality_bound.py.
...
Pure stdlib. Run:  python3 tools/optimality_bound_validate.py [--per-regime N]
"""
...
from autosolver import optimality_bound as ob  # noqa: E402
